...
# ============================================
# CAUTION: Production infrastructure - review changes carefully
...
variable "storage_lifecycle_days" { type = number; default = 365 }
variable "vertex_ai_machine_type" { type = string; default = "n1-standard-16" }
variable "vector_search_shard_size" { type = string; default = "SHARD_SIZE_MEDIUM" }
variable "bq_delete_contents_on_destroy" { type = bool; default = false }
variable "enable_private_google_access" { type = bool; default = true }
variable "enable_multi_region" { type = bool; default = false }
variable "replica_regions" { type = list(string); default = ["us-east1", "us-west1"] }
